...
const MainPage = () => {
  ...
  const displayXP = totalXP > 0 ? totalXP : 18; // 기본값
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#F8FFFE' }}>
      ...
      <main className="flex-1 px-4 py-4 pb-20 space-y-5">
        ...
        >
          <p className="text-sm opacity-90 mb-1">2025년 1학기</p>
          <h1 className="text-xl font-bold mb-3">안녕하세요, {user?.name} 님! 👋</h1>
          ...
          <p className="text-xs opacity-80 mb-2">재등록 요건 : 3xp</p>
          <div className="w-full h-2 rounded-full mb-4" style={{ backgroundColor: 'rgba(255,255,255,0.3)' }}>
            <div className="h-full rounded-full" style={{ width: '100%', backgroundColor: '#FFFFFF' }}></div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D1FAE5' }}>
            ...
            <p className="text-3xl font-bold" style={{ color: '#0F4C3A' }}>{attendanceCount > 0 ? attendanceCount : 6}회</p>
          </div>
          <div className="rounded-xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D1FAE5' }}>
            <div className="flex items-center gap-1 text-xs mb-1" style={{ color: '#6B7280' }}>
              <Calendar className="w-3 h-3" /> 행사 참여
            </div>
            <p className="text-3xl font-bold" style={{ color: '#0F4C3A' }}>{eventCount > 0 ? eventCount : 2}회</p>
          </div>
          <div 
        ...
        <section>
          ...
          <div className="rounded-xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D1FAE5' }}>
            <div className="flex items-center justify-between mb-2">
              <h3 className="font-semibold" style={{ color: '#0F4C3A' }}>정기모임 #8</h3>
              <span 
                className="px-2 py-1 rounded-full text-xs flex items-center gap-1"
                style={{ backgroundColor: '#D1FAE5', color: '#10B981' }}
              >
                <Sparkles className="w-3 h-3" /> 3 XP
              </span>
            </div>
            <div className="space-y-1 text-sm mb-3" style={{ color: '#6B7280' }}>
              <p className="flex items-center gap-2"><Calendar className="w-4 h-4" /> 1월 6일 (월)</p>
              <p className="flex items-center gap-2"><Clock className="w-4 h-4" /> 오후 7시</p>
              <p className="flex items-center gap-2"><MapPin className="w-4 h-4" /> N412</p>
              <p className="flex items-center gap-2"><Users className="w-4 h-4" /> {mainScheduleParticipants}명 참여</p>
            </div>
            <button 
              className="w-full py-3 rounded-xl font-semibold text-sm text-white transition-all"
              style={{ 
                backgroundColor: mainScheduleJoined ? '#10B981' : '#0F4C3A',
              }}
        ...
        <section>
          ...
          <div className="rounded-xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D1FAE5' }}>
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="font-semibold text-sm mb-1" style={{ color: '#0F4C3A' }}>2025년 1학기 운영 계획 공지</h3>
                <p className="text-xs mb-2" style={{ color: '#6B7280' }}>
                  2025년 1학기 동아리 운영 계획이 확정되었습니다. 정기모임은 매주 월요일 오후 7시에 진행됩니
                </p>
                <p className="text-xs">
                  <span style={{ color: '#10B981' }}>운영</span>
                  <span style={{ color: '#6B7280' }}> 2025-01-20</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="rounded-xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D1FAE5' }}>
            <div className="flex items-start justify-between mb-2">
              <h3 className="font-semibold" style={{ color: '#0F4C3A' }}>다음 세미나 주제</h3>
              <span 
                className="px-2 py-1 rounded-full text-xs flex items-center gap-1"
                style={{ backgroundColor: '#D1FAE5', color: '#10B981' }}
              >
                <Sparkles className="w-3 h-3" /> +2 XP
              </span>
            </div>
            <p className="text-sm mb-1" style={{ color: '#6B7280' }}>2월 정기 세미나 주제를 선택해주세요</p>
        ...
        <div className="text-center py-4">
          <p className="text-sm" style={{ color: '#6B7280' }}>
            coma-room은 참여를 장려하고 있어요. ✨
          </p>
          <p className="text-sm" style={{ color: '#6B7280' }}>
            온 사람을 기록하고, 함께한 순간을 남겨요.
          </p>
        </div>
        ...
        <footer className="rounded-xl p-6 space-y-6" style={{ backgroundColor: '#FFFFFF', border: '1px solid #D1FAE5' }}>
          <div>
            ...
            <p className="text-sm" style={{ color: '#6B7280' }}>
              COMA 동아리 회원들의 활동을 관리하고, 소통하며, 성장하는 공간입니다. 출석부터 행사, 투표, 앨범까지 모든 동아리 활동을 한 곳에서 관리하세요.
            </p>
          </div>

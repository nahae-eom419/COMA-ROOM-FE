      ...
      <main className="flex-1 px-4 py-4 pb-24 space-y-4">
        ...
        >
          <div className="grid grid-cols-3 gap-4 text-center text-white">
            <div>
              ...
              <p className="text-sm opacity-80">참여 중</p>
            </div>
            <div>
              <p className="text-3xl font-bold">{stats.totalXP}</p>
              <p className="text-sm opacity-80">총 획득 XP</p>
            </div>
            <div>
              <p className="text-3xl font-bold">{stats.completed}</p>
              <p className="text-sm opacity-80">완료한 스터디</p>
            </div>
          </div>
        </div>
        ...
        >
          <button
            ...
            style={{ 
              backgroundColor: activeTab === "my" ? '#FFFFFF' : 'transparent',
              color: activeTab === "my" ? '#0F4C3A' : '#6B7280'
            }}
          ...
          <button
            ...
            style={{ 
              ...
              color: activeTab === "join" ? '#0F4C3A' : '#6B7280'
            }}
          ...
          <button
            ...
            style={{ 
              ...
              color: activeTab === "completed" ? '#0F4C3A' : '#6B7280'
            }}
            ...
            joinableStudies.map((study) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-1">
                  <h3 className="font-bold text-lg" style={{ color: '#0F4C3A' }}>
                    {study.title}
                  </h3>
                  <span 
                    className="px-3 py-1 rounded-full text-xs font-medium"
                    style={{ 
                      backgroundColor: study.level === "초급" ? '#D1FAE5' : '#FEF3C6',
                      color: study.level === "초급" ? '#007A55' : '#BB4D00'
                    }}
                  >
                    {study.level}
                  </span>
                ...
                <div className="flex gap-2 mb-3">
                  {study.tags.map((tag, index) => (
                    <span 
                      ...
                      style={{ backgroundColor: '#F1F5F9', color: '#0F4C3A' }}
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex items-center justify-between mb-3 text-sm" style={{ color: '#6B7280' }}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span style={{ color: '#0F4C3A' }}>{study.leader}</span>
                  </div>
                </div>
            ...
            completedStudies.map((study) => (
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-xl font-bold" style={{ color: '#0F4C3A' }}>
                      {study.totalSessions}
                    </p>
                    <p className="text-xs" style={{ color: '#6B7280' }}>총 세션</p>
                  </div>
                  <div>
                    <p className="text-xl font-bold" style={{ color: '#10B981' }}>
                      {study.attendance}
                    </p>
                    <p className="text-xs" style={{ color: '#6B7280' }}>참석</p>
                  </div>
                  <div>
                    <div className="flex items-center justify-center gap-1">
                      <Sparkles className="w-4 h-4" style={{ color: '#E17100' }} />
                      <p className="text-xl font-bold" style={{ color: '#10B981' }}>
                        {study.xp}
                      </p>
                    </div>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span 
                      ...
                      style={{ 
                        backgroundColor: study.role === "리더" ? '#CAD5E2' : '#D1FAE5',
                        color: study.role === "리더" ? '#314158' : '#10B981'
                      }}
                    >
                      {study.role}
                    </span>
                ...
                <div className="mb-3">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-sm" style={{ color: '#6B7280' }}>진행률</span>
        ...
        >
          <h3 className="font-semibold text-sm mb-2 flex items-center gap-1" style={{ color: '#10B981' }}>
            <Lightbulb className="w-4 h-4" /> 스터디 안내
          </h3>
          <ul className="text-sm space-y-1" style={{ color: '#0F4C3A' }}>
            <li>• 스터디 참여 시 매 세션마다 2 XP를 받아요</li>
            <li>• 스터디 완료 시 보너스 XP를 받을 수 있어요</li>
            <li>• 리더는 스터디 운영 경험을 쌓을 수 있어요</li>
          </ul>
        </div>
      </main>
